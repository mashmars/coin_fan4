...
class CoinClient
{
	...
	public function __call($method, array $params)
	{
		...
		//var_dump((array('method' => $method, 'params' => $params, 'res' => $res), 'Coinclient execute'));
	...
	private function doRequest(array $payload)
	{
		...
		$metadata = stream_get_meta_data($stream); ///var_dump($metadata);
		$response = json_decode(stream_get_contents($stream), true);
		echo '==> Request: ' . PHP_EOL . json_encode($payload, JSON_PRETTY_PRINT);
